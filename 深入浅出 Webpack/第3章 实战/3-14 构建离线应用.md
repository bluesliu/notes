...
- 由于 Service Workers 必须在 HTTPS 环境下才能拦截网络请求实现离线缓存，使用在 [2-6 DevServer https](http://webpack.wuhaolin.cn/2%E9%85%8D%E7%BD%AE/2-6DevServer.html) 中提到的方式去实现 HTTPS 服务。
...
![图3.12.1 查看当前页面注册的 Service Workers](https://ws3.sinaimg.cn/large/006tKfTcly1g0kvxilkowj30yy0cc0vl.jpg)

通过打开开发者工具的 Application-Cache-Cache Storage 一栏，能看到当前页面缓存的资源列表，正常的效果如图：

![图3.12.2 查看当前页面的 Cache Storage](https://ws4.sinaimg.cn/large/006tKfTcly1g0kvxj9ws5j312008gjt9.jpg)

为了验证网页在离线时能访问的能力，需要在开发者工具中的 Network 一栏中通过 Offline 选项禁用掉网络，再刷新页面能正常访问，并且网络请求的响应都来自 Service Workers，正常的效果如图：

![图3.12.3 离线情况下访问页面](https://ws4.sinaimg.cn/large/006tKfTcly1g0kvxjrzh0j31ly0dudjv.jpg)

> 本实例[提供项目完整代码](http://webpack.wuhaolin.cn/3-14%E6%9E%84%E5%BB%BA%E7%A6%BB%E7%BA%BF%E5%BA%94%E7%94%A8.zip)
